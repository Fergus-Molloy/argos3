...
namespace argos {
   ...
   std::string COmnidirectionalCameraEquippedEntity::GetQueryDocumentation(const SDocumentationQuerySpec& c_spec) {
     std::string strDoc =
         ...
         "             from the center of the " + c_spec.strEntityName + "). Defaults to" + std::to_string(c_spec.fOffsetDefault) + "if omitted. Units of meters.\n\n"
     ...
     std::string strExamples =
         "Example XML Omndirectional configurations (default values shown):\n\n"
