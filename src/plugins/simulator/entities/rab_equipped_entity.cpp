...
namespace argos {
   ...
   std::string CRABEquippedEntity::GetQueryDocumentation(const SDocumentationQuerySpec& c_spec) {
     ...
     std::string strDoc =
         ...
         "- 'range' - The emission range (the maximum distance from message source) of the " + c_spec.strEntityName + " \n"
         "            that another robot can receive a message, specified in meters. Defaults to " + std::to_string(c_spec.fRangeDefault) + "\n"
         "            meters if omitted.\n\n"
         ...
         " - 'pos_offset' - The displacement from the center of the "  + c_spec.strEntityName + " to place the RAB sensor\n"
         "                  and/or actuator at in X,Y,Z. Units of meters. Defaults to " + cPosOffsetDefault.str() + " if omitted.\n\n"

         " - 'rot_offset' - The rotational offset of the "  + c_spec.strEntityName + " to place the RAB sensor\n"
         "                  and/or actuator at in along the Z,Y,X axes. Units of degrees. Defaults to " + cRotOffsetDefault.str() + "\n"
         "                  if omitted.\n\n";
